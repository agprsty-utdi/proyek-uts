...
use App\Http\Requests\MstPangkatRequest;
...
class MstPangkatController extends Controller
{
    ...
    public function index()
    {
        ...
        $mstPangkat = DB::table('mst_pangkats')
     ...
     */
    public function store(MstPangkatRequest $request)
    {
        //mulai transaksi
        DB::beginTransaction();
        try{
     ...
     */
    public function update(MstPangkatRequest $request, string $id)
    {
        DB::beginTransaction();
        try{
            ...
            DB::rollback();
            return redirect()->route('mst-pangkat.index')
            ->with('error', 'Tabel Pangkat Batal diubah, ada kesalahan');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            DB::rollback();
            return redirect()->route('mst-pangkat.index')
            ->with('error', 'Tabel Pangkat ada kesalahan hapus batal.');
        }
    }
}
