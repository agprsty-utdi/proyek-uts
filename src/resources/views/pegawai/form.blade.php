<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-row">
            {{ Form::label('Alamaat', 'Alamat', ['class' => 'col-sm-3 col-form-label', 'style' => 'font-weight:bold;']) }}
            <div class="col-sm-9">
        ...
        <div class="form-row">
            ...
            <div class="col-sm-9">
                {{ Form::text('telepon', $pegawai->telepon, [
        ...
        <div class="form-row">
            ...
            <div class="col-sm-9">
                {{ Form::file('file_foto', null, [
                    'class' => 'form-control' . ($errors->has('file_foto') ? ' is-invalid' : ''),
                    'placeholder' => 'Foto',
                ]) }}
                {!! $errors->first(
                    'file_foto',
        ...
        <div class="form-row">
            ...
            <div class="col-sm-9">
                @if ($pegawai->file_foto)
                    <img id="original" src="{{ url('/foto/' . $pegawai->file_foto) }}" width="50%">
                @endif
            </div>
        </div>
    </div>
